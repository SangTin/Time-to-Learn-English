...
public class AutoCompleteTextField extends TextField {
     ...
     */
    private final SortedSet<Word> entries;
     ...
     */
    private final ObservableList<Word> filteredEntries
     ...
     */
    public AutoCompleteTextField(SortedSet<Word> entrySet)
    {
        super();
        ...
        textProperty().addListener((ObservableValue<? extends String> observableValue, String s, String s2) ->
        {
            ...
            {
                LinkedList<Word> searchResult = new LinkedList<>();
                ...
                {
                    Matcher matcher = pattern.matcher(entry.getWordTarget());
                    if (matcher.matches())
                    {
     ...
     */
    public SortedSet<Word> getEntries()
    {
        return entries;
    }
    ...
    public ObservableList<Word> getFilteredEntries()
    {
